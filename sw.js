const CACHE='dojun-pwa-v68-portionback2';
const CORE=[
  './meal-stock-v66.js','./meal-workflow-v68-portion2.js','./legacy-inventory-v61-photo.js',
  './','./index.html','./manifest.webmanifest','./legacy-v68-nav2.html',
