...
assert(/\.\/legacy-v24\.html\?v=20260915-v\d+/.test(index),'original app must remain the default UI');
assert(/legacy-management-v29\.js\?v=20260915-v\d+/.test(index),'v29 management extension must be injected');
