...
assert(index.includes('legacy-management-v78-bundle.js?r=20260923-v78-fastboot1'),'v32 patch must be present through the consolidated bundle');
assert(index.includes('legacy-management-v78-bundle.js?r=20260923-v78-fastboot1'),'room-temperature patch must be present through the consolidated bundle');
