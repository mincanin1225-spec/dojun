...
assert(index.includes('legacy-management-v78-bundle.js?r=20260924-v80-makelabel1'),'v32 patch must be present through the consolidated bundle');
assert(index.includes('legacy-management-v78-bundle.js?r=20260924-v80-makelabel1'),'room-temperature patch must be present through the consolidated bundle');
