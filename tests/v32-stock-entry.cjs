...
assert(/legacy-management-v32\.js\?v=20260915-v[\w-]+/.test(index),'v32 patch must be loaded with a fresh cache key');
assert(/legacy-management-v32-1\.js\?v=20260915-v[\w-]+/.test(index),'room-temperature patch must be loaded with a fresh cache key');
