...
assert(patch.includes("nav.textContent='네이버지도'"),'place card map action must clearly say Naver Maps');
...
console.log('PASS: v37 polishes outing UI and adds Naver Maps bridge without changing outing data storage');
