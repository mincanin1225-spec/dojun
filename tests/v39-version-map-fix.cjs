...
assert(patch.includes("const DISPLAY_VER=window.__DOJUN_RELEASE?.version||'v61'"),'displayed app version must come from the canonical release inside the v39 patch');
