...
assert(core.includes("name:'도준이키우기',version:'v59'"),'core release metadata must be canonical');
...
assert(sw.includes("const CACHE='dojun-pwa-v59'"),'v58 PWA cache missing');
...
console.log('PASS: v59 canonical brand/version, Ppeuni D+291, stock safety and fast PWA cache');
