...
assert(core.includes("name:'도준이키우기',version:'v61'"),'core release metadata must be canonical');
...
assert(sw.includes("const CACHE='dojun-pwa-v61'"),'v58 PWA cache missing');
