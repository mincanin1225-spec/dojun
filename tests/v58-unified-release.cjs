...
assert(core.includes("name:'도준이키우기',version:'v58'"),'core release metadata must be canonical');
...
assert(sw.includes("const CACHE='dojun-pwa-v58'"),'v58 PWA cache missing');
...
console.log('PASS: v58 canonical brand/version, Ppeuni D+291, stock safety and fast PWA cache');
