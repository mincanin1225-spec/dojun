...
assert(index.includes("const RELEASE='20260923-v76-calmark1'"),'index must carry the current PWA release marker');
...
assert(sw.includes("const CACHE='dojun-pwa-v76-calmark1'"),'new cache generation missing');
