...
new Function(flow);
assert(index.includes("./meal-workflow-v70.js?r=20260923-v76-calmark1"),'index must load the new physical workflow filename');
...
assert(index.includes("const RELEASE='20260923-v77-mealvisual1'"),'index must carry the current PWA release marker');
...
assert(sw.includes("const CACHE='dojun-pwa-v77-mealvisual1'"),'new cache generation missing');
