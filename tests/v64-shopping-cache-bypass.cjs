...
new Function(flow);
assert(index.includes("./meal-workflow-v70.js?r=20260922-v70-feedfix2"),'index must load the new physical workflow filename');
...
assert(index.includes("const RELEASE='20260922-v70-feedfix2'"),'index must carry the current PWA release marker');
...
assert(sw.includes("const CACHE='dojun-pwa-v70-feedfix2'"),'new cache generation missing');
