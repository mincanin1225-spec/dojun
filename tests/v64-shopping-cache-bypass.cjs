...
new Function(flow);
assert(index.includes("./meal-workflow-v70.js?r=20260921-v70-cookundo2"),'index must load the new physical workflow filename');
...
assert(index.includes("const RELEASE='20260921-v70-cookundo2'"),'index must carry the current PWA release marker');
...
assert(sw.includes("const CACHE='dojun-pwa-v70-cookundo2'"),'new cache generation missing');
