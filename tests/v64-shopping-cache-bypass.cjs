...
new Function(flow);
assert(index.includes("./meal-workflow-v67.js?r=20260921-v67"),'index must load the new physical workflow filename');
...
assert(sw.includes("'./meal-workflow-v67.js'"),'service worker must precache the new workflow filename');
assert(sw.includes("const CACHE='dojun-pwa-v67-prepcheck1'"),'new cache generation missing');
