...
new Function(flow);
assert(index.includes("./meal-workflow-v65.js?r=20260921-v65"),'index must load the new physical workflow filename');
...
assert(sw.includes("'./meal-workflow-v65.js'"),'service worker must precache the new workflow filename');
assert(sw.includes("const CACHE='dojun-pwa-v65-shoppingraw1'"),'new cache generation missing');
