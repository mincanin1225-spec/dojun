...
assert(sw.includes("const CRITICAL=['/legacy-v70.html','/meal-stock-v66.js','/meal-workflow-v70.js','/legacy-management-v33.js','/legacy-health-v43.js','/legacy-outing-v36.js']"),'critical active assets must use the network-first path');
