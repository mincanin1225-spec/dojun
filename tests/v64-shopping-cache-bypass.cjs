...
new Function(flow);
assert(index.includes("./meal-workflow-v70.js?r=20260923-v78-fastboot1"),'index must load the new physical workflow filename');
...
assert(sw.includes("const CACHE='dojun-pwa-v78-fastboot1'"),'new cache generation missing');
