...
assert(shell.includes("name:'도준이키우기',version:'v72'"),'active shell canonical release must be v70');
assert(index.includes('<iframe id="app" src="./legacy-v70.html?r=20260922-v72-recordonly4"'),'index must load the new physical v69 shell');
...
assert(sw.includes("const CACHE='dojun-pwa-v72-recordonly4'"),'v69 shell cache marker missing');
