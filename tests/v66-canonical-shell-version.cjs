...
assert(shell.includes("name:'도준이키우기',version:'v76'"),'active shell canonical release must be v70');
assert(index.includes('<iframe id="app" src="./legacy-v70.html?r=20260923-v76-calmark1"'),'index must load the new physical v69 shell');
...
assert(sw.includes("const CACHE='dojun-pwa-v76-calmark1'"),'v69 shell cache marker missing');
