...
assert(shell.includes("name:'도준이키우기',version:'v80'"),'active shell canonical release must be v70');
assert(index.includes('<iframe id="app" src="./legacy-v70.html?r=20260924-v80-simpleprep1"'),'index must load the new physical v69 shell');
...
assert(sw.includes("const CACHE='dojun-pwa-v80-simpleprep1'"),'v69 shell cache marker missing');
