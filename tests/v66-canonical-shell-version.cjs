...
assert(index.includes('<iframe id="app" src="./legacy-v70.html?r=20260921-v70-cookundo3"'),'index must load the new physical v69 shell');
...
assert(sw.includes("const CACHE='dojun-pwa-v70-cookundo3'"),'v69 shell cache marker missing');
