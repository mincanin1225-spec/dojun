...
assert(index.includes("./legacy-v70.html?r=20260922-v73-recordonly5"),'index must load navigation-safe shell');
assert(index.includes("./meal-workflow-v70.js?r=20260922-v73-recordonly5"),'index must load unified cooking workflow');
