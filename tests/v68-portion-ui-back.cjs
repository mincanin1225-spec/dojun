...
assert(index.includes("./legacy-v70.html?r=20260921-v70-cookundo3"),'index must load navigation-safe shell');
assert(index.includes("./meal-workflow-v70.js?r=20260921-v70-cookundo3"),'index must load unified cooking workflow');
...
assert(sw.includes("const CACHE='dojun-pwa-v70-cookundo3'"),'unified cooking cache marker missing');
