...
assert(index.includes("./meal-workflow-v70.js?r=20260922-v70-coreflowfix2"),'index must load unified cooking workflow');
...
assert(sw.includes("const CACHE='dojun-pwa-v70-coreflowfix2'"),'unified cooking cache marker missing');
