...
assert(index.includes("./legacy-v70.html?r=20260922-v70-recordonly1"),'index must load navigation-safe shell');
assert(index.includes("./meal-workflow-v70.js?r=20260922-v70-recordonly1"),'index must load unified cooking workflow');
...
assert(sw.includes("const CACHE='dojun-pwa-v70-recordonly1'"),'unified cooking cache marker missing');
