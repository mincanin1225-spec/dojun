...
assert(index.includes("./meal-workflow-v70.js?r=20260922-v70-feedfix1"),'index must load unified cooking workflow');
...
assert(sw.includes("const CACHE='dojun-pwa-v70-feedfix1'"),'unified cooking cache marker missing');
