...
assert(index.includes("./legacy-v70.html?r=20260923-v76-calmark1"),'index must load navigation-safe shell');
...
assert(sw.includes("const CACHE='dojun-pwa-v76-calmark1'"),'unified cooking cache marker missing');
