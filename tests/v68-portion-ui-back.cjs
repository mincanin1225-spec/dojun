...
assert(index.includes("./legacy-v70.html?r=20260922-v72-recordonly4"),'index must load navigation-safe shell');
assert(index.includes("./meal-workflow-v70.js?r=20260922-v72-recordonly4"),'index must load unified cooking workflow');
