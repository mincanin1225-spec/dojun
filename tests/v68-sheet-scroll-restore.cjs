...
assert(index.includes('./legacy-v68-scroll3.html?r=20260921-v68-scroll3'),'index must load the scroll-restoring physical shell');
assert(sw.includes("'./legacy-v68-scroll3.html'"),'service worker must precache the scroll-restoring shell');
assert(sw.includes("const CACHE='dojun-pwa-v68-scroll3'"),'scroll-restoring cache generation missing');
