...
assert(index.includes('./legacy-v70.html?r=20260923-v76-calmark1'),'index must load v69 shell');
assert(index.includes('./meal-workflow-v70.js?r=20260923-v76-calmark1'),'index must load v69 workflow');
assert(shell.includes("name:'도준이키우기',version:'v76'"),'canonical version must be v69');
assert(sw.includes("const CACHE='dojun-pwa-v76-calmark1'"),'v69 cache missing');
