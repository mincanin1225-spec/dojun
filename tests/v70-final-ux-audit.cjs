...
assert(index.includes('./meal-workflow-v70.js?r=20260922-v70-feedfix1'),'index must load v70 workflow');
assert(shell.includes("name:'도준이키우기',version:'v70'"),'canonical version must be v70');
assert(sw.includes("const CACHE='dojun-pwa-v70-feedfix1'"),'v70 cache missing');
