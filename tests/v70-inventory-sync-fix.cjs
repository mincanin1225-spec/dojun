...
assert(index.includes("const RELEASE='20260922-v70-feedfix1'"),'PWA release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v70-feedfix1'"),'PWA cache marker must refresh');
