...
assert(index.includes('legacy-management-v33.js?v=20260916-v40&r=20260922-v73-recordonly5'),'inventory renderer must use a fresh release URL');
assert(index.includes("const RELEASE='20260922-v73-recordonly5'"),'PWA release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v73-recordonly5'"),'PWA cache marker must refresh');
