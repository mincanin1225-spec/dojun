...
assert(index.includes('legacy-v70.html?r=20260922-v70-manualaudit1'),'active shell release must refresh');
assert(index.includes('legacy-health-v43.js?v=20260916-v43&r=20260922-v70-manualaudit1'),'health module release must refresh');
assert(index.includes("const RELEASE='20260922-v70-manualaudit1'"),'PWA release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v70-manualaudit1'"),'PWA cache marker must refresh');
