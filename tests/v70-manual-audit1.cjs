...
assert(index.includes('legacy-v70.html?r=20260922-v70-recordonly1'),'active shell release must refresh');
assert(index.includes('legacy-health-v43.js?v=20260916-v43&r=20260922-v70-recordonly1'),'health module release must refresh');
