...
assert(index.includes('legacy-v70.html?r=20260924-v79-buyonly1'),'active shell release must refresh');
assert(index.includes('legacy-health-v43.js?v=20260916-v43&r=20260924-v79-buyonly1'),'health module release must refresh');
assert(index.includes("const RELEASE='20260924-v79-buyonly1'"),'PWA release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v79-buyonly1'"),'PWA cache marker must refresh');
