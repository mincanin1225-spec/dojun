...
assert(index.includes('legacy-v70.html?r=20260922-v71-recordonly2'));
assert(index.includes('legacy-outing-v36.js?v=20260916-v40&r=20260922-v71-recordonly2'));
assert(index.includes('health-schedule-v43.js?v=20260916-v43&r=20260922-v71-recordonly2'));
assert(index.includes('legacy-outing-v40-seed.js?v=20260916-v40&r=20260922-v71-recordonly2'));
assert(index.includes('legacy-outing-v41-no-embedded-map.js?v=20260916-v41&r=20260922-v71-recordonly2'));
assert(index.includes("const RELEASE='20260922-v71-recordonly2'"));
assert(sw.includes("const CACHE='dojun-pwa-v71-recordonly2'"));
