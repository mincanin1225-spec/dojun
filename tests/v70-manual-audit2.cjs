...
assert(index.includes('legacy-v70.html?r=20260922-v70-coreflowfix2'));
assert(index.includes('legacy-outing-v36.js?v=20260916-v40&r=20260922-v70-coreflowfix2'));
...
assert(index.includes("const RELEASE='20260922-v70-coreflowfix2'"));
assert(sw.includes("const CACHE='dojun-pwa-v70-coreflowfix2'"));
