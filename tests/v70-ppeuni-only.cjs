...
assert(index.includes('legacy-ppeuni-v58-safe.js?v=20260919-v58&r=20260922-v71-recordonly2'),'Ppeuni-only patch must load with a fresh cache key');
assert(index.includes("const RELEASE='20260922-v71-recordonly2'"),'release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v71-recordonly2'"),'PWA cache must refresh');
