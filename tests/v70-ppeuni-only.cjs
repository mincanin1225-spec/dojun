...
assert(index.includes('legacy-ppeuni-v58-safe.js?v=20260919-v58&r=20260924-v80-simpleprep1'),'Ppeuni-only patch must load with a fresh cache key');
assert(index.includes("const RELEASE='20260924-v80-simpleprep1'"),'release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v80-simpleprep1'"),'PWA cache must refresh');
