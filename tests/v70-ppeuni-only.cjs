...
assert(index.includes('legacy-ppeuni-v58-safe.js?v=20260919-v58&r=20260922-v72-recordonly4'),'Ppeuni-only patch must load with a fresh cache key');
assert(index.includes("const RELEASE='20260922-v72-recordonly4'"),'release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v72-recordonly4'"),'PWA cache must refresh');
