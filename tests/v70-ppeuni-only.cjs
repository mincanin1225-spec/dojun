...
assert(index.includes("const RELEASE='20260922-v70-feedfix1'"),'release marker must refresh');
assert(sw.includes("const CACHE='dojun-pwa-v70-feedfix1'"),'PWA cache must refresh');
