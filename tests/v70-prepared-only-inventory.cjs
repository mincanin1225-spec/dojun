...
assert(index.includes('meal-stock-v66.js?r=20260922-v66-preparedonly1'));
assert(index.includes('meal-workflow-v70.js?r=20260922-v70-preparedonly1'));
assert(index.includes("const RELEASE='20260922-v70-preparedonly1'"));
assert(sw.includes("const CACHE='dojun-pwa-v70-preparedonly1'"));
